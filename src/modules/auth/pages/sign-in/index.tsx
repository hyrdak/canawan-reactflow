      ...
      <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-md dark:border dark:border-gray-700 p-6 space-y-4">
        ...
        <form className="space-y-4" action="#" onSubmit={(e) => { e.preventDefault(); signin_action(); }}>
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
            <input
              className={`bg-gray-700 border ${emailError ? 'border-red-500' : 'border-gray-600'} text-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
              id="email"
              type="email"
              placeholder="Nhập địa chỉ email"
              value={email}
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlFor="password">Mật khẩu</label>
            <input
              className={`bg-gray-700 border ${passwordError ? 'border-red-500' : 'border-gray-600'} text-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
              id="password"
              type="password"
              placeholder="Vui lòng nhập mật khẩu"
              value={password}
